...
<figure>
  ...
  <figcaption><b>Fig. 3: We identify cross-attention layers responsible for style, facts, and object generation. Modifying the input to those layers changes model's generation respecting the attribute.</b></figcaption>
</figure>
